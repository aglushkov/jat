...
describe "Jat::Plugins::JsonApiActiverecordPreloads" do
  before do
    @plugin = Jat::Plugins.find_plugin(:json_api_activerecord_preloads)
  end
  ...
  it "loads other plugins" do
    ...
    serializer_class.plugin :json_api_activerecord_preloads
