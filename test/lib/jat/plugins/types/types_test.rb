...
describe "Jat::Plugins::Types" do
  ...
  def attr_value(original_value)
    ...
    serializer_class.attributes[:attr].value(obj, nil)
  end

  it "has predefined :int type" do
    serializer_class.attribute(:attr, type: :int)
  ...
  it "has predefined :bool type" do
    serializer_class.attribute(:attr, type: :bool)
  ...
  it "has predefined :float type" do
    serializer_class.attribute(:attr, type: :float)
  ...
  it "has predefined :array type" do
    serializer_class.attribute(:attr, type: :array)
  ...
  it "has predefined :hash type" do
    serializer_class.attribute(:attr, type: :hash)
  ...
  it "has predefined :str type" do
    serializer_class.attribute(:attr, type: :str)
  ...
  it "allows to use callable method as type" do
    serializer_class.attribute(:attr, type: ->(obj) { obj ? :yes : :no })
  ...
  it "allows to configure custom type" do
    serializer_class.config[:types][:year] = ->(obj) { obj.strftime("%Y") }
    serializer_class.attribute(:attr, type: :year)

    assert_equal("2020", attr_value(Time.new(2020, 10, 10)))
  end

  it "allows to skip type" do
    serializer_class.attribute(:attr)
